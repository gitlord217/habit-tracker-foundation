...
/**
 * UnifiedPage combines authentication and dashboard in a single page
 * to avoid navigation/redirection issues 
 */
...
function DashboardContent({ user, onLogout }: { user: any, onLogout: () => void }) {
  const { todayCompletions, isLoading, toggleCompletion, completionRates, weeklyTrend } = useHabits();
